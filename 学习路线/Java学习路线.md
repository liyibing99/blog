...
Java 8 是如今企业开发中最主流的 Java 稳定版本，在这个版本出现了很多实用的新特性，能够提升编程效率，建议学习。
...
## 阶段 2：巩固基础
注意！如果你时间不够，那么本章节甚至可以完全跳过，先去学习开发框架做项目，后面再慢慢弥补基础即可。
...
Maven / Gradle 当成工具用就好，跟着框架教程去用就行了，先不用花太多时间去深入学。
...
学习完框架后，即可跟着边学边做项目。用项目驱动学习，更快地掌握后端必学技术。
...
### 🌕 Git
详情请参考学习路线：[Git & GitHub 学习路线](Git&GitHub学习路线.md)
...
### 🌖 Linux
详情请参考学习路线：[Linux 学习路线](Linux学习路线.md)
...
### 🌘 前端基础
详情请参考前端学习路线：[前端学习路线](前端学习路线.md)

在企业中，往往需要前后端程序员配合完成工作。会一些前端，不仅可以提高你们的协作效率，还能提高自己对整个项目的了解和掌控力，甚至能独立开发出一个完整项目！
...
大学软件专业的必修课，偏理论，能学到很多企业软件开发的方法，也是对软件开发同学综合能力的提升，有时间的话可以了解下。
...
### 🌖 设计模式
详情请参考学习路线：[设计模式学习路线](设计模式学习路线.md)
...
缓存是高并发系统不可或缺的技术，可以提高系统的性能和并发，而 Redis 是实现缓存的最主流技术，因此它是后台开发必学的知识点。
...
### 🌖 消息队列
消息队列是用于传输和保存消息的容器，也是大型分布式系统中常用的技术，主要解决应用耦合、异步消息、流量削锋等问题。后台开发必学。
...
建议先学习 RabbitMQ，比 Kafka 要好理解一些。跟着视频教程实操一遍即可，可以等到后面再去深入了解原理和高级特性。
...
Nginx 是主流的、开源的、高性能的 HTTP 和反向代理 web 服务器，可以用于挂载网站、请求转发、负载均衡、网关路由等。前后端开发同学都需要学习，在后端开发有时会考到。
...
- 视频 
   ...
   - ⭐ Nginx - 手把手带你从0搭建个人网站：[https://www.bilibili.com/video/BV1rU4y1J785/](https://www.bilibili.com/video/BV1rU4y1J785/) （简单演示 Nginx 部署网站）
- 文档 
...
很少问 Spring Cloud 框架的细节，更多的是微服务以及各组件的一些思想，比如网关的好处、消息总线的好处等。
...
业务上云是趋势，但是对于开发同学来说，会用 Docker / K8S 部署项目和服务就行。实际工作中，企业一般都有现成的平台直接用，考察的也不多，不用花太多时间。
...
-  实战平台 
   - ⭐ 微信云托管：[https://cloud.weixin.qq.com/cloudrun](https://cloud.weixin.qq.com/cloudrun) 
   - 前端托管 Webify：[https://cloud.tencent.com/product/webify](https://cloud.tencent.com/product/webify)

### 练手项目
学习完框架后，即可跟着项目教程系列边学边做项目。用项目驱动学习，更快地掌握后端必学技术。
...
综合所学技术从 0 到 1 开发和上线一个全面、有特色的个人项目。
...
已经到了这个阶段，建议除了看完整的教程外，平时多自主搜索信息去学习，积少成多。比如遇到了一个不了解的名词，可以去网上搜一下，感兴趣的话再进行下一步的学习。

### 🌖 并发编程

对 Java 后端开发程序员来说，懂得如何利用有限的系统资源来提高系统的性能是很重要的，也是考察的重点，因此并发编程（尤其是 Java 并发包的使用）这块的知识很重要。
